...
#### 6.1.2 卡牌系统初始化（CardLoader.js + cards.csv）
...
#### 6.6.1 天灾卡系统（DisasterCard.js）

- 特殊抽卡规则：抽到天灾卡会自动进入灾难区
- 全局影响效果：如太阳风暴影响太空类股票

#### 6.6.2 动态波动率（Stock.js）
